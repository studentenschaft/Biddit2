...
export function FilteredCoursesDemo() {
  ...
  const applyFilterToAllSemesters = () => {
    updateFilteredCoursesForAllSemesters(demoFilterOptions, selectedCourseIds);
  };
    ...
    <div className="p-6 bg-white rounded-lg shadow-lg max-w-4xl mx-auto my-4">
      ...
      <div className="mt-6 p-4 bg-gray-100 rounded">
        ...
        <div className="text-sm text-gray-600 space-y-1">
          <p>
            <code>
              updateFilteredCourses(semesterName, filterOptions,
              selectedCourseIds)
            </code>{" "}
          ...
          <p>
            <code>
              updateFilteredCoursesForAllSemesters(filterOptions,
              selectedCourseIds)
            </code>{" "}
